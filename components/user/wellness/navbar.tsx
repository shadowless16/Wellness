...
const navItems: NavItem[] = [
  { name: 'dashboard', href: '/user', icon: <Heart className="w-5 h-5" />, label: 'Dashboard' },
  { name: 'meditation', href: '/user/meditation', icon: <Music className="w-5 h-5" />, label: 'Meditation' },
  { name: 'goals', href: '/user/goals', icon: <Target className="w-5 h-5" />, label: 'Goals' },
  { name: 'mood', href: '/user/mood', icon: <BarChart3 className="w-5 h-5" />, label: 'Mood' },
  { name: 'community', href: '/user/community', icon: <Users className="w-5 h-5" />, label: 'Community' },
  { name: 'insights', href: '/user/insights', icon: <TrendingUp className="w-5 h-5" />, label: 'Insights' },
  { name: 'journal', href: '/user/journal', icon: <BookOpen className="w-5 h-5" />, label: 'Journal' },
  { name: 'resources', href: '/user/resources', icon: <BookMarked className="w-5 h-5" />, label: 'Resources' },
  { name: 'saved', href: '/user/saved', icon: <Bookmark className="w-5 h-5" />, label: 'Saved' },
